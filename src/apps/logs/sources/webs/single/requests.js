...
const debug = Debug('apps:logs:sources:webs:single:requests')
...
const host_once_component = {
  params: function (_key, vm) {
    debug('PERIODICAL host_range_component %o %o', _key, vm.web)
      ...
      switch (_key) {
        case 'periodical.once':
          source = [{
            ...
            range: 'posix 1557134755000' + '-' + 1557134755000 + MINUTE + '/*', //= > home test data
            query: {
              'from': 'logs',
              // 'register': 'changes',
              'format': 'tabular',
